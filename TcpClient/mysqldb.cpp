...
// set some basic message of the database
...
// create a new table named "tbname" in "db"
...
// insert the message "txt" into the tabel "tbname"
int MYsqldb::importdata(QSqlDatabase db, QString tbname,QString username,QString tm ,int type,QString txt)
{
...
// export all data in table "tbname"
QStringList MYsqldb::exportdatall(QSqlDatabase db, QString tbname)
{
    QSqlQuery query;
    QStringList sqlist;
